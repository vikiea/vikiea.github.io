...
See [PRIVACY.md](https://github.com/vikiea/age_mac/blob/master/PRIVACY.md) and the hosted privacy page at [vikiea.github.io/age_mac/privacy/](https://vikiea.github.io/age_mac/privacy/).
...
The CLI wraps build, run, debug, verification, packaging, PR, and GitHub Release actions from any working directory. See [Tools/age-mac-cli/README.md](https://github.com/vikiea/age_mac/blob/master/Tools/age-mac-cli/README.md).
